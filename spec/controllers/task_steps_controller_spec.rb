...
RSpec.describe TaskStepsController, type: :controller do
  ...
  # TaskStep. As you add validations to TaskStep, be sure to
  ...
  # TaskStepsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "returns a success response" do
      TaskStep.create! valid_attributes
  ...
  describe "GET #show" do
    it "returns a success response" do
      task_step = TaskStep.create! valid_attributes
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new TaskStep" do
        expect {
          post :create, params: {task_step: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {task_step: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested task_step" do
        task_step = TaskStep.create! valid_attributes
        put :update, params: {id: task_step.to_param, task_step: new_attributes}, session: valid_session
        task_step.reload
      ...
      it "redirects to the task_step" do
        task_step = TaskStep.create! valid_attributes
        put :update, params: {id: task_step.to_param, task_step: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        task_step = TaskStep.create! valid_attributes
        put :update, params: {id: task_step.to_param, task_step: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
